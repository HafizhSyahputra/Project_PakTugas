...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="pesawat">Data Pesawat <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
    ...
    <h1 align="center" style="margin-top: 100px;">Pesawat</h1>
    <div class="container mt-5">
        <?php if ($this->session->userdata('role') === 'admin') : ?>
            <a href="<?php echo base_url('pesawat/buat'); ?>" style=" text-decoration: none; color: navy; " >➕ Create </a>
        <?php endif; ?>
        <table class="table" border="1" style="margin-top: 20px; margin-bottom: 390px; " >
            ...
            <?php foreach ($pesawat as $pesawats) : ?>
                <tr>
                    <td><?php echo $pesawats->id_pesawat; ?></td>
                    <td><?php echo $pesawats->name; ?></td>
                    <td><?php echo $pesawats->type; ?></td>
                    <td><?php echo $pesawats->capacity; ?></td>
                    <?php if ($this->session->userdata('role') === 'admin') : ?>
                        <td>
                            <a href="<?php echo base_url('pesawat/edit_pesawat/' . $pesawats->id_pesawat); ?>" class="edel" >Edit</a> |
                            <a href="#" onclick="confirmDelete(<?php echo $pesawats->id_pesawat; ?>);" class="edel" >Delete</a>
                        </td>
                    <?php endif; ?>
                </tr>
            <?php endforeach; ?>
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = "<?php echo base_url('pesawat/delete_pesawat/'); ?>" + id;
